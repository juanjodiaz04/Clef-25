...
def main():
    ...
    parser.add_argument("--run_dir", type=str, required=True, help="Base de la ruta del run")
    ...
    parser.add_argument("--out_csv", type=str, required=True, help="Archivo de salida para la inferencia")
    ...
    run_dir = os.path.join(args.run_dir, f"run_{args.run}")
    ...
    pred_df.to_csv(args.out_csv, index=False, float_format="%.12f")
    print(f"Submission guardado como: {args.out_csv}")
